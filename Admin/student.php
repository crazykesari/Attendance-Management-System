     ...
     <h1><b>Online Attendance Management System</b></h1>
	  ...
	  <div id="box">
	   ...
	   <li><a class="login"href="logout.php">Logout</a></li>
		 		 ...
		 		 <div id="parent">
		   <div id="child1">
		      <p class="font"><a class="link"href="stdregister.php">Add Student</a></p>
		      </div>
		   <div id="child2">
		   		      <p class="font"><span id="myBtn"class="link">View Student</span></p>
		      </div>
		   <div id="child3">
		   		      <p class="font"><span id="myBtn1"class="link">Delete Student</a></p>
		      </div>
...
<div id="myModal" class="modal">
 ...
 <span class="close0"></span>
    <form action="viewstudent.php"name="vform"method="post"style="text-align:center; font-size:30px">
	   <p>StudentId:</p>
	   <input type="text"name="id"></br></br>
	   <span style="color:blue;font-size:20px; font-family:sans-serif;border:1px solid blue"><b>OR</b></span>
	   <p>Section:</p>
	   <input type="text"name="section"value="cs3a" ></br></br>
...
<div id="myModal1" class="modal">
  ...
  <div class="modal-content">
	...
	<p style="font-size:27px">Delete Student</p> 
	<hr></hr>
	      <form action="studentdelete.php"method="post"name="delform" onsubmit="return Validate()"style="text-align:center; font-size:25px">
    	 <p>StudentId:</p>
	   <input type="text"name="id"></br></br>
